...
public class Google2Api extends DefaultApi20 {
    ...
    private static final String AUTHORIZE_URL = "https://accounts.google.com/o/oauth2/auth?prompt=consent&hd=flipkart.com&response_type=code&client_id=%s&redirect_uri=%s";
